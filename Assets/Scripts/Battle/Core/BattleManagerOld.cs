...
namespace Battle.Core
{
    public class BattleManagerOld : MonoBehaviour
    {
        ...
        // [SerializeField] private Sprite attackIcon, skill1Icon, skill2Icon;
        ...
        // private System.Action selectedSkillAction = null;
        ...
        //     // 🔺 적이 선택된 상태에서 타일을 클릭한 경우: 해제만 수행
        //     if (selectedEnemy != null)
        //     {
        //         DeselectEnemy();
        //         ClearAttackTiles();  // 범위 초기화
        //         HighlightMoveableTiles(SelectedPlayer); // 다시 파랑 표시
        //         return;
        //     }
        ...
        // {
        //     if (!IsPlayerTurn || selectedEnemy == null) return;

        //     Debug.Log($"⚔️ 공격 실행: 선택된 스킬 {selectedSkillIndex}");

        //     switch (selectedSkillIndex)
        //     {
        //         case 0: selectedEnemy.ReceiveAttack(10); break;
        //         case 1: selectedEnemy.ReceiveAttack(6); break;
        //         case 2: selectedEnemy.ReceiveAttack(20); break;
        //     }

        //     ClearAttackTiles(); // ✅ 하이라이트 제거
        //     DeselectEnemy();
        //     IsPlayerTurn = false;
        //     CheckBattleEnd();
        //     StartCoroutine(ProcessNextAction());
        ...
        // {
        //     if (!IsPlayerTurn || currentEnemy == null) return;
        ...
        // private void CreateSkillSlot(Sprite icon, string desc, int skillIndex)
        // {
        //     var slot = Instantiate(skillSlotPrefab, skillPanelParent).GetComponent<UISkillSlot>();
        //     slot.Init(icon, desc, () => SelectSkill(skillIndex, slot));
        ...
        // private void SelectSkill(int index, UISkillSlot slot)
        // {
        //     if (selectedSkillSlot != null)
        //         selectedSkillSlot.SetSelected(false); // 이전 선택 해제

        //     selectedSkillSlot = slot;
        //     selectedSkillIndex = index;
        //     selectedSkillSlot.SetSelected(true); // 현재 선택 강조

        //     Debug.Log($"🧩 선택된 스킬 인덱스: {index}");
        //     UIDescriptionPanel.Instance.Show("🧠 [스킬] 더블 스트라이크\n두 번 공격하며 SP를 10 소모합니다.");
        // }
        ...
        // {
        //     ClearExistingSkillSlots();

        //     CreateSkillSlot(attackIcon, "DMG10\nSP0", 0);
        //     CreateSkillSlot(skill1Icon, "DMG6\nSP10", 1);
        //     CreateSkillSlot(skill2Icon, "DMG20\nSP20", 2);
        // }
        // private void ClearExistingSkillSlots()
        // {
        ...
        // {
        //     // TODO: 승리 패널을 띄우거나 씬 전환
        //     Time.timeScale = 0;
        //     UIDescriptionPanel.Instance.Show("🎖️ 전투 승리!\n수고하셨습니다.");
        // }
